...
const VideoTile = ({
  ...
  const isVideoOn = typeof videoEnabled === "boolean" ? videoEnabled : true;
  const isAudioOn = typeof audioEnabled === "boolean" ? audioEnabled : true;
  ...
  return (
    <article className={`video-tile${isFeatured ? " video-tile-featured" : ""}${isPinned ? " is-pinned" : ""}`}>
      ...
      <div className="video-tile-media">
        ...
        />
        {!isVideoOn && <div className="video-tile-video-off">Camera off</div>}
      </div>
